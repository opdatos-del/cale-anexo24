...
import { ListProfilesUseCase } from '../profiles/application/use-cases/list-profiles.use-case';
import { ProfileRepository } from '../profiles/domain/repositories/profile.repository';
import { HttpProfileRepository } from '../profiles/infrastructure/repositories/http-profile.repository';
