...
| Reportes | Bitácora | PENDIENTE | Fuente legacy no demostrada; `app24.BitacoraEvento` sólo diseño/DDL | — | — | — | PENDIENTE; no crear endpoint hasta confirmar fuente canónica y controles de auditoría |
