...
-- Consultas read-only de perfiles y actividades Fase 5C.
GRANT EXECUTE ON OBJECT::app24.APP24_Q_PERFILES_LISTAR TO app24_runtime;
GRANT EXECUTE ON OBJECT::app24.APP24_Q_ACTIVIDADES_LISTAR TO app24_runtime;
GRANT EXECUTE ON OBJECT::app24.APP24_Q_PERFIL_PERMISOS_LISTAR TO app24_runtime;

-- Commands atómicos de SP-1C y Fase 5C.
...
GRANT EXECUTE ON OBJECT::app24.APP24_C_USUARIO_RESTABLECER_PASSWORD TO app24_runtime;
GRANT EXECUTE ON OBJECT::app24.APP24_C_BITACORA_REGISTRAR TO app24_runtime;
GRANT EXECUTE ON OBJECT::app24.APP24_C_PERFIL_CREAR TO app24_runtime;
